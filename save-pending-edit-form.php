...
if (isset($_POST['submit'])) {
    ...
    if (!empty($profile_pic)){
        ...
        $result = mysqli_query($db, "UPDATE funds_form set cause_title='$cause_title',location='$location',eligible='$eligible',profile_pic='$profile_pic',amount='$amount',cause_explain='$cause_explain',cause_summary='$cause_summary'  where id='$id' ");
    }
    else {
        $result = mysqli_query($db, "UPDATE funds_form set cause_title='$cause_title',location='$location',eligible='$eligible',amount='$amount',cause_explain='$cause_explain',cause_summary='$cause_summary' where id='$id'");
    }
?>
<script>
    let id = <?= $id?>;
