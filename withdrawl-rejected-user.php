...
<title>Withdrawl Rejected</title>
        ...
        <div class="height-100 ">
            ...
            <div class="table-responsive w-100 ">
                <table class="table border">
                    ...
                    <tbody>
                        <?php
                        $query = mysqli_query($db, "SELECT * FROM withdrawl_pending where status='Rejected' and email='$useremail'");
                        ...
                        ?>
                            <tr>
                                ...
                                ?>
                                    ...
                                    <td class=" text-danger fw-bolder"><?php echo $row1['status']; ?></td>
                            </tr>
                    <?php
                                }
                            }
