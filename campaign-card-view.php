<a class="col ht cause_card text-decoration-none text-dark" data-bs-toggle="tooltip" href="campaign-details.php?campaign=<?php echo $data['id']; ?>" data-bs-placement="bottom" title="<?php echo $data['cause_title']; ?>">
